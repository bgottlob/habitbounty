 ...
 *   returns null
 */
module.exports.dateStr = function(dateStr) {
 ...
 */
module.exports.logEntry = function(entry) {
  let err = null;
  if (err = this.number(entry.amount)) return err;
  else if (err = this.dateStr(entry.date)) return err;
  else {
